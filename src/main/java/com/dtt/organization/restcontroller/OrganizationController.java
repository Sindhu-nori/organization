...
//    private OrganizationDeletionService deletionService;
    ...
    public ApiResponses registerOrganization(@Valid @RequestBody RegisterOrganizationDTO registerOrganizationDTO) throws OrgnizationServiceException {
    ...
    public ApiResponses updateOrgnization(@RequestBody RegisterOrganizationDTO updateOrganizationDTO) throws OrgnizationServiceException {
    ...
    public ApiResponses addOrganizationEmails(@RequestBody EmailList emailList) throws JsonProcessingException {
        String methodName = Utility.getMethodName();
    ...
    public ApiResponses verfiySignedDocument(@RequestBody SignatureVerificationContext1 signatureVerificationContext) throws JsonProcessingException, OrgnizationServiceException {
        String methodName = Utility.getMethodName();
    ...
    public ApiResponses getAllOrg(@RequestParam("searchType") String searchType) {
        logger.info(CLASS + "getOrganizationBySearchType {} ", searchType);
        ApiResponses organiationList = organizationServiceImpl.getOrganizationBySerachType(searchType);
        return organiationList;

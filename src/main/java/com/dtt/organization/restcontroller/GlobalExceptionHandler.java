...
//    @ExceptionHandler(OrgnizationServiceException.class)
//    public ResponseEntity<ApiResponse> handleOrganizationServiceException(OrgnizationServiceException ex) {
//        return ResponseEntity.badRequest().body(
//            AppUtil.createApiResponse(false, ex.getMessage(), null)
//        );
//    }
 ...
 // Return only the first validation error
    ...
    public ResponseEntity<ApiResponses> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.badRequest().body(
            AppUtil.createApiResponse(false, errorMessage, null)
        );
    }
}

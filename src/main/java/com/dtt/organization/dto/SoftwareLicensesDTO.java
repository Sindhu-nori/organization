...
//		return "{" + "\"applicationType\" : \"" + applicationType + "\"," + "\"issuedOn\" : \""
//				+ issuedOn + "\"," + "\"validUpto\" : \"" + validUpto + "\"," + "\"privateKey\" : \""
//				+ privateKey + "\"," + "\"clientassertiontype\" : \"" + "urn:ietf:params:oauth:client-assertion-type:jwt-bearer" +
//				"\"," + "\"clientId\" : \"" + clientId +"}";
//	}

	public String licenseInfoOLD(String issuedOn, String validUpto) {
		return "{" + "\"clientId\" : \"" + clientId + "\"," + "\"issuedOn\" : \"" + issuedOn + "\","
				+ "\"validUpto\" : \"" + validUpto + "\"," + "\"licenseType\" : \"" + licenseType + "\","
				+ "\"applicationType\" : \"" + applicationType + "\"}";
	}

	public String licenseInfo(String issuedOn, String validUpto, String licenseType, String privatekey) {
		return "{" + "\"clientId\" : \"" + clientId + "\"," + "\"issuedOn\" : \"" + issuedOn + "\","
				+ "\"validUpto\" : \"" + validUpto + "\"," + "\"licenseType\" : \"" + licenseType + "\","
				+ "\"privatekey\" : \"" + privatekey + "\"," + "\"applicationType\" : \"" + applicationType + "\"}";
	}

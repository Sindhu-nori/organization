...
public class SubscriberStatus implements Serializable {
	 ...
	 *
	 * @param otpVerifiedStatus the new otp verified status
	 */
	 ...
	 *
	 * @param subscriberStatus the new subscriber status
	 */
	 ...
	 *
	 * @param subscriberStatusDescription the new subscriber status description
	 */
	 ...
	 *
	 * @param subscriberStatusId the new subscriber status id
	 */
	 ...
	 *
	 * @param subscriberUid the new subscriber uid
	 */

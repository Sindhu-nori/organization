...
public interface OrgContactsEmailRepository extends JpaRepository<OrgContactsEmail, Integer> {
	...
	//@Query(value = "select * from org_subscriber_email WHERE organization_uid=?1",nativeQuery = true)
	...
	//	@Modifying
//	@Query(value = "call ra_0_2.delete_org_email(?1)", nativeQuery = true)
//	@Transactional(rollbackFor = Exception.class)
//	public int deleteOrganizationEmailById(String organizationUid);
//	@Procedure(name = "OrgContactsEmail.deleteOrgEmail")
